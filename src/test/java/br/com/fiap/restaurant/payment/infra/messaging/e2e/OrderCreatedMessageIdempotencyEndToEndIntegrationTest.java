...
class OrderCreatedMessageIdempotencyEndToEndIntegrationTest extends AbstractPaymentE2ETest {
    ...
    @Test
    void shouldProcessOrderCreatedOnlyOnceWhenSameMessageIsPublishedTwice() {
        ...
        Integer outboxCount = jdbcTemplate.queryForObject("""
                ...
                """, Integer.class, "%" + orderData.orderId() + "%");

        assertThat(outboxCount).isEqualTo(1);

        Map<String, Object> outboxRow = awaitOutboxRowForOrderAndEventType(
                orderData.orderId(),
                "PAYMENT_APPROVED"
        );
